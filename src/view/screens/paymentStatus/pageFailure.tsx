    ...
    >
      ...
      >
        ...
        <button
          onClick={() =>
            window.open(
              `https://api.whatsapp.com/send?phone=${config.supportWhatsapp.replace(/\+/, '')}&text=Meu%20pagamento%20no%20${encodeURIComponent(config.name)}%20falhou.%20Poderia%20me%20ajudar%3F`,
              '_blank',
            )
          }
